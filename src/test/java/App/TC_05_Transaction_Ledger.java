...
public class TC_05_Transaction_Ledger {
	@Test
	public void setup() throws MalformedURLException, InterruptedException {
		...
		//transaction ledger
		Thread.sleep(5000);
		MobileElement ledger = driver.findElement(By.xpath("//android.view.View[@content-desc=\"Transaction Ledger\"]"));
		ledger.click();
		
		//download
		Thread.sleep(5000);
		MobileElement download = driver.findElement(By.xpath("//android.view.View[@index=2]"));
		download.click();
		//invoice
			Thread.sleep(5000);
//				MobileElement invoice = driver.findElement(By.xpath("//android.view.View[@content-desc=\"MIS-0033 COTTON ASSOCIATION OF INDIA Transaction Date 16-May-2023\"]"));
//				invoice.click();
}
}
